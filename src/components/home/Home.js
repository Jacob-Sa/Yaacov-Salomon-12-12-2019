...
import { getSuggestions,getFiveDaysWeather,getGeoposition,getCurrentConditions } from '../../store/actions/actions';
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        getCurrentConditions: (cityKey) => dispatch(getCurrentConditions(cityKey))
    }
}
